...
describe("Empathy Routes", () => {
  ...
  describe("POST /api/reports/:id/empathy", () => {
    it("should add empathy successfully", async () => {
      mockEmpathyService.addEmpathy.mockResolvedValue({ empathyCount: 1 });
    ...
    it("should use existing user identifier from cookie", async () => {
      mockEmpathyService.addEmpathy.mockResolvedValue({ empathyCount: 2 });
    ...
    it("should return 409 for duplicate empathy", async () => {
      mockEmpathyService.addEmpathy.mockRejectedValue(
        new Error("이미 공감하셨습니다")
      );
  ...
  describe("DELETE /api/reports/:id/empathy", () => {
    it("should remove empathy successfully", async () => {
      mockEmpathyService.removeEmpathy.mockResolvedValue({ empathyCount: 0 });
    ...
    it("should return 404 when empathy not found", async () => {
      mockEmpathyService.removeEmpathy.mockRejectedValue(
        new Error("공감을 찾을 수 없습니다")
      );
  ...
  describe("GET /api/reports/:id/empathy/count", () => {
    it("should get empathy count successfully", async () => {
      ...
      expect(mockEmpathyService.getEmpathyCount).toHaveBeenCalledWith(
        "report-123"
      );
    });
    ...
    it("should handle service errors", async () => {
      mockEmpathyService.getEmpathyCount.mockRejectedValue(
        new Error("Database error")
      );
  ...
  describe("GET /api/reports/:id/empathy/check", () => {
    ...
    it("should handle service errors", async () => {
      mockEmpathyService.checkEmpathy.mockRejectedValue(
        new Error("Database error")
      );
